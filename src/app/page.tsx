...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white relative overflow-hidden w-full">
      ...
      {/* Hero Section */}
      <section className="relative z-10 pt-48 pb-[100px] flex flex-col items-center text-center px-6 w-full">
        <motion.div {...fadeInUp}>
        ...
        <div className="w-full max-w-[1200px] mx-auto">
          <motion.div 
            className="mt-[100px] grid grid-cols-1 md:grid-cols-3 gap-4 w-full"
            variants={stagger}
            initial="initial"
            whileInView="animate"
            viewport={{ once: true }}
